...
// Obtener el enlace para "Matlab" por su id
const collapseMatlabLink = document.getElementById("collapsePMatlab");
// Obtener el menú colapsable "Matlab" por su id
const collapseMatlab = document.getElementById("collapseMatlab");
// Obtener el ícono en el enlace
const iconM = collapseMatlabLink.querySelector(".fas.fa-chevron-down");

// Agregar un escuchador de eventos al enlace "Matlab"
collapseMatlabLink.addEventListener("click", function(event) {
  console.log('collapseMatlabLink')
  event.preventDefault(); // Evitar el comportamiento predeterminado del enlace
  // Toggle de la clase "show" en el menú colapsable "Matlab"
  collapseMatlab.classList.toggle("show");
    // Cambiar dinámicamente el ícono
    if (iconM.classList.contains("fa-chevron-down")) {
        iconM.classList.remove("fa-chevron-down");
        iconM.classList.add("fa-chevron-up");
    } else {
        iconM.classList.remove("fa-chevron-up");
        iconM.classList.add("fa-chevron-down");
    }
});

// Obtener el enlace para "Python" por su id
const collapsePythonLink = document.getElementById("collapsePPython");
// Obtener el menú colapsable "Python" por su id
const collapsePython = document.getElementById("collapsePython");
// Obtener el ícono en el enlace
const iconP = collapsePythonLink.querySelector(".fas.fa-chevron-down");

// Agregar un escuchador de eventos al enlace "Python"
collapsePythonLink.addEventListener("click", function(event) {
  console.log('collapsePythonLink')
  event.preventDefault(); // Evitar el comportamiento predeterminado del enlace
  // Toggle de la clase "show" en el menú colapsable "Python"
  collapsePython.classList.toggle("show");
  // Cambiar dinámicamente el ícono
  if (iconM.classList.contains("fa-chevron-down")) {
    iconP.classList.remove("fa-chevron-down");
    iconP.classList.add("fa-chevron-up");
  }else {
    iconP.classList.remove("fa-chevron-up");
    iconP.classList.add("fa-chevron-down");
  }
});
...
function loadMarkdown(mdFile) {
    ...
    fetch(mdFile)
      ...
      .then(data => {
        ...
        // Forzar a MathJax a procesar el contenido
